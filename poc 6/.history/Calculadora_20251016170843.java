...
public class Calculadora {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Esta calculadora puede sumar dos numeros, sumar tres numeros, restar, multiplicar, dividir y calcular potencias");
        System.out.println();
        ...
        try {
            ...
            System.out.println("2. Sumar tres numeros (+++)");
            System.out.println("3. Restar (-)");
            System.out.println("4. Multiplicar (*)");
            System.out.println("5. Dividir (/)");
            System.out.println("6. Potencia (^)");
            System.out.print("Ingresa tu opcion (1, 2, 3, 4, 5 o 6): ");
            
            int opcion = scanner.nextInt();
            double numero3 = 0;
            
            // Si la opcion es sumar tres numeros, solicitar el tercer numero
            if (opcion == 2) {
            ...
            switch (opcion) {
                ...
                case 2 -> {
                    resultado = calculadora.sumarTresNumeros(numero1, numero2, numero3);
                    operacion = "+++";
                }
                case 3 -> {
                ...
                default -> {
                    System.out.println("Opcion invalida. Se realizara la suma por defecto.");
                    resultado = calculadora.sumar(numero1, numero2);
                    operacion = "+";
                }
            }
            ...
            System.out.println();
            if (opcion == 2) {
                System.out.println("El resultado de " + numero1 + " + " + numero2 + " + " + numero3 + " = " + resultado);
            } else {
            ...
            System.out.println("Error: Por favor ingresa numeros validos (enteros o decimales)");
        } finally {
            scanner.close();
        }
    }
