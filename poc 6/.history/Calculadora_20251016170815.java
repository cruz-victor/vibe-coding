    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            double resultado = switch (opcion) {
                ...
                case 2 -> calculadora.sumarTresNumeros(numero1, numero2, numero3);
                case 3 -> calculadora.restar(numero1, numero2);
                case 4 -> calculadora.multiplicar(numero1, numero2);
                case 5 -> calculadora.dividir(numero1, numero2);
                case 6 -> calculadora.power(numero1, numero2);
                default -> {
                    System.out.println("Opción inválida. Se realizará la suma por defecto.");
                    yield calculadora.sumar(numero1, numero2);
                }
            };
